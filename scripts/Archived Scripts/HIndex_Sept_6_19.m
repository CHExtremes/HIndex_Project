...
for i = 1:stationLength %for each station
    ...
    %create an array with the year in the left most column, the name of the
    %station at the top of the column and the H-Index for each
    %corresponding year in the cells below station names
